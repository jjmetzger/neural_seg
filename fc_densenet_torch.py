...
__all__ = ['fcdensenet_tiny', 'fcdensenet56_nodrop',
           'fcdensenet56', 'fcdensenet67', 'fcdensenet103']


# modified from https://gist.github.com/felixgwu
...
class FCDenseNet(nn.Module):
    ...
    def __init__(self, depths, growth_rates, n_scales=5, n_channel_start=48,
                 n_classes=12, drop_rate=0, bottle_neck=False, n_channel_image=3):
        ...
        self.conv_first = nn.Conv2d(
            n_channel_image, n_channel_start, 3, stride=1, padding=1, bias=True)
...
def fcdensenet_tiny(drop_rate=0, n_classes=2, n_channel_image=1):
    return FCDenseNet(2, 6, drop_rate=drop_rate, n_classes=n_classes, n_channel_image=n_channel_image)


def fcdensenet56_nodrop(n_classes=2, n_channel_image=1):
    return FCDenseNet(4, 12, drop_rate=0, n_classes=n_classes, n_channel_image=n_channel_image)


def fcdensenet56(drop_rate=0.2, n_classes=2, n_channel_image=1):
    return FCDenseNet(4, 12, drop_rate=drop_rate, n_classes=n_classes, n_channel_image=n_channel_image)


def fcdensenet67(drop_rate=0.2, n_classes=2, n_channel_image=1):
    return FCDenseNet(5, 16, drop_rate=drop_rate, n_classes=n_classes, n_channel_image=n_channel_image)


def fcdensenet103(drop_rate=0.2, n_classes=2, n_channel_image=1):
    return FCDenseNet([4, 5, 7, 10, 12, 15, 12, 10, 7, 5, 4], 16,
                      drop_rate=drop_rate, n_classes=n_classes, n_channel_image=n_channel_image)


def fcdensenet103_nodrop(drop_rate=0, n_classes=2, n_channel_image=1):
    return FCDenseNet([4, 5, 7, 10, 12, 15, 12, 10, 7, 5, 4], 16,
                      drop_rate=drop_rate, n_classes=n_classes, n_channel_image=n_channel_image)
